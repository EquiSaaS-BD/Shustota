        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-[#0a1628]">
              {t("Your Personal AI Health Assistant: ", "আপনার ব্যক্তিগত এআই স্বাস্থ্য সহকারী: ")}
              <span className="animate-gradient-text bg-gradient-to-r from-primary via-secondary to-tertiary bg-clip-text text-transparent bg-[length:200%_auto]">
                {t("Smarter, Faster, and Always Available", "আরও স্মার্ট, আরও দ্রুত এবং সবসময় আপনার পাশে")}
              </span>
            </h1>

            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-[500px]">
              {t(
                "Get instant, AI-driven health guidance, symptom analysis, and prescription insights. Find the right doctors and medicines seamlessly in one secure platform.",
                "লক্ষণ বিশ্লেষণ, প্রেসক্রিপশন স্ক্যান, ডাক্তার খোঁজা এবং ওষুধের বিস্তারিত তথ্য জানুন নিমেষেই। সবকিছুই পাচ্ছেন এক প্ল্যাটফর্মে, সম্পূর্ণ বিনামূল্যে।"
              )}
            </p>
