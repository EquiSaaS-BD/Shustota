...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    login({
      ...
      name: "Demo User",
      email: email,
      role: role as "patient" | "doctor" | "hospital" | "admin"
    });
  };
    ...
    <main className="min-h-screen bg-white flex flex-col items-center py-10 px-4 sm:px-6">
      ...
      <div className="w-full max-w-[500px]">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button type="submit" className="w-full h-[54px] bg-[#70DE71] hover:bg-[#5bc95c] text-white rounded-xl font-bold transition-all shadow-md active:scale-[0.98]">
            Log In
          </button>
        </form>
        ...
        <div className="mt-10">
          ...
          <div className="flex justify-center gap-4">
            <button 
              ...
              className="w-14 h-14 rounded-full border-2 border-slate-200 bg-white flex items-center justify-center hover:border-[#70DE71] hover:bg-[#70DE71]/5 transition-all cursor-pointer"
